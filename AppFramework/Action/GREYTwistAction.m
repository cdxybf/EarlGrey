...
- (NSArray *)calculateTouchPaths:(UIView *)view
  ...
  CGFloat radius = MIN(centerPoint.x, centerPoint.y) * kTwistScale / 2.0;

  // If rotation is counterclockwise, start with fingers horizontally.  Otherwise,
  // start with fingers vertically.
