...
/**
 * Generates a touch path rotating along a curved path along a circle of
 * radius @c radius centered at the specified @c center point, moving
 * from angle @c startAngle to @c endAngle over the specified @c duration.
 *
